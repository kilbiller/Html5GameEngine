    ...
    for (let entity of this.game.world.entities) {
      ...
      if (entity.type === "player") {
        if (!this.texts[entity.id]) {
          let playerHPBar = new PIXI.extras.BitmapText(
            "Health: " + ec.health.hp,
            {
              font: "18px Consolas"
            }
      ...
      if (entity.type === "enemy") {
        if (ec.health.isAlive && !this.texts[entity.id]) {
          let enemyHPBar = new PIXI.extras.BitmapText(
            "Health: " + ec.health.hp,
            {
              font: "18px Consolas"
            }
        ...
        if (this.texts[entity.id]) {
          ...
          this.texts[entity.id].y =
            ec.sprite.sprite.y +
            this.game.worldDoc.y -
            this.texts[entity.id].height;
